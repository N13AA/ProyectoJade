...
<body>
    <form id="form1" runat="server">
        <asp:Button ID="Button2" runat="server" Text="Sign Up" ForeColor="white" BackColor="#009975" />
  ...
  <div id="formContent">
    ...
    <form>
      <%--<input type="text" id="login" class="fadeIn second" name="login" placeholder="login"/>--%>
        <asp:TextBox ID="TxtUsuario" class="fadeIn second" name="login" placeholder="Login" minlength="4" MaxLength="15" runat="server"> </asp:TextBox>
